...
# Load the Road image with ye Yassmine 🙂

Road_image = cv2.imread('Road.png', cv2.IMREAD_UNCHANGED)



# Function to detect lane in an street

def detect_Street(frame):
    ...
    for contour in contours:
        ...
        if len(approx) == 4:
            ...
            # Adjust these thresholds based Road line
